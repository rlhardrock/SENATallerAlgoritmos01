...
async function calcularNotaFinal() {
     const calificacion= await calificacion('Ingresar calificación del primer parcial: ');
     ...
     const promedio = (calificacion* 0.30) + (calificacion2 * 0.30) + (calificacionFinal * 0.40);
